...
Actualmente, el uso de las computadores en las ciencias es fundamental, al grado de que el desarrollo
del cómputo creó una nueva rama de la química, la \textbf{química computacional}.
Adicionalmente, las sorprendente evoluciones de las matemáticas, la física y la química teórica ha contribuido al florecimiento de la química computacional, al proveernos de conceptos, modelos
...
\item Los cálculos están limitados sólo por la velocidad de la computadora y la capacidad de memoria de ésta.
\end{enumerate}
...
y la energía de Gibbs. Estas propiedades se consideran relevantes porque brindan información acerca de la estabilidad y la termodinámica de las moléculas, y porque a partir de ellas, es posible entender varios fenómenos que ocurren en los procesos químicos.

Se denomina \textbf{entalpía de formación} (representada como $\Delta_{f}H^{\circ}$) a la energía involucrada en la reacción química que relaciona la formación de 1 mol de un compuesto a partir de sus elementos en su forma más estable a una atmósfera de presión y a una temperaratura dada.
...
con costos computacionales aceptables (véase p. ej. los métodos introducidos por Pople et al\cite{Cuevas2003}). Una categoría muy popular de estos métodos combinados es la que está
...
Algunos de esos métodos son: Gn (G1, G2, G3, G4).  Existen otras técnicas como CBS-N(CBS-APNO y CBS-QB3)  \cite{Simmie2015}, pero en este trabajo abordaremos exclusivamente los métodos G3 y G4 del software \textbf{Gaussian09} \cite{g09}.
...
los enlaces de la molécula para obtener a sus átomos en fase gasesosa  \cite{Nicolaides1996}. Ahora bien, es común que las entalpías de formación estén tabuladas en condiciones normales de
...
rigido para el movimiento rotacional y el oscilador armónico para el movimiento vibracional\cite{Nicolaides1996} .
Adicionalmente, pueden incorporarse correcciones más finas como la aproximación de Nicolaides et al \cite{McQuarrie1976}.
