...
De los 3 enfoques anteriores, el método de atomización da mejores resultados, especialmente para moléculas orgánicas y es concenpualmente el más sencillo, porque se basa en la ruptura de enlaces de una molécula para obtener a sus atomos en fase gasesosa\cite{Nicolaides1996}. Veamos el principio del método de atomización con la molécula de metanol. \\
...
\caption{Diagrama de entalpía de atomización de metanol. El diagrama no implicar que el metanol necesariamente se encuentre por encima de sus elementos en entalpía.}
\label{atm-metanol}
\end{center}
\end{figure}
...
pagina 354 Lewars  (segunda tabla)



Ahora, para ajustar la entalpía de formación de T = 0 K a T = 298.15 K, sumamos el aumento de entalpía del metanol al pasar de T = 0 K a T = 298.15 K y restamos los aumentos correspondientes de los elementos en sus estados estándar. El valor del metanol es la diferencia de dos cantidades de G4 (298 K y 0 K) proporcionadas en el resumen termoquímico al final del cálculo de G4 implementado en \textit{Gaussian 09}. 
