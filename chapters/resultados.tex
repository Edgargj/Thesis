...
Es posible apreciar la entalpía de formación a T = 298.15 K de las 15 simulaciones realizadas en la línea 21 de cada molécula. Todos los resultados coinciden con los valores de las moléculas de 2NBA, 3NBA y 4NBA reportados por Ximello y otros autores \cite{Ximello2020}, véase las tablas \ref{Ximello-table-1}, \ref{Ximello-table-2} y \ref{Ximello-table-3}.  
...
Enthalpies of formation of gaseous atoms at and thermal corrections for elements in their standard states at 298.15 K from:                   
...
\hline  
\end{tabular} 
\caption{Entalpías de formación en fase condesada por el método G4 de Gaussian del 2-nitrobenzaldehído (2NBA), 3-nitrobenzaldehído (3NBA) y 4-nitrobenzaldehído (4NBA) a T = 298.15 K y p° = 0.1 MPa, reportadas por Ximello y otros autores \cite{Ximello2020}, obsérvese la segunda columna.}
...
\hline  
\end{tabular} 
\caption{Entalpías de formación en fase condesada por el método G3MP2 de Gaussian del 2-nitrobenzaldehído (2NBA), 3-nitrobenzaldehído (3NBA) y 4-nitrobenzaldehído (4NBA) a T = 298.15 K y p° = 0.1 MPa, reportadas por Ximello y otros autores \cite{Ximello2020}, obsérvese la segunda columna.}
