...
\caption{Molécula de metanol, utilizada para explicar el diagrama de flujo general del programa EnthalpyNIST.}
\label{metanol}
\end{center}
\end{figure}
...
Los pasos 8 y 9 son de los más importantes del programa, porque calculan la energía interna (paso 6) usando ecuaciones que provienen de la Termodinámica Estadística. Se inicia con dos sentencias de condición que evalúan parámetros de la molécula, como son:
\begin{enumerate}
