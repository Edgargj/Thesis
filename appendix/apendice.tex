...
\begin{lstlisting}
$./computeEnthalpyG4.x -flag  molecule.txt$
\end{lstlisting}
...
$-a$
\end{lstlisting}
Utilizar los valores experimentales de los átomos de Hidr\'ogeno, Carbono, Nitr\'ogeno, Oxi\'{\i}geno y Azufre reportados por  ARGONNE-DATA from J. Phys. Chem. 100 17460 (1996).
\begin{lstlisting}
$-s$ 
\end{lstlisting}
