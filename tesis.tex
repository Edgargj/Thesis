%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%	PROYECTO DE TESIS
%%	Este template está basado en el código fuente de la tesis
%%	de Eliud Morales Dávila. Si lo utilizas, por favor no borres
%%	este encabezado, si lo mejoras, añade tu nombre a la lista
%% de contribuyentes.
%%
%% CONTRIBUYENTES:
